...
public class LongestSubstringWithAtLeastKRepeatingCharacters {
    ...
    private static int longestSubstringWithNUniqueChars(String s, int k, int uniqueCharCount) {
    ...
    public static void main(String[] args) {
        String str1 = "aaabb";
        System.out.println(longestSubstring(str1, 3));
        String str2 = "aacbbbdc";
        System.out.println(longestSubstring(str2, 2));
        String str3 = "bbaaacbd";
        System.out.println(longestSubstring(str3, 3));
    }
}
