 ...
 *
 */
public class RearrangeStringWithSameCharactersKApart {
    public static String rearrangeString(String s, int k) {
        ...
        return result.length() == s.length() ? result.toString() : "Could Not create such a string";
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(rearrangeString(str1, 3));
        System.out.println(rearrangeString(str2, 3));
        System.out.println(rearrangeString(str3, 2));
    }
}
